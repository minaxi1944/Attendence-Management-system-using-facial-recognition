...
class req:
    ...
    def student_page():
        return render_template('student_page.html',username=session['username'])
    ...
    def subject_choice():
        ...
        return render_template('ui.html', msg=subject_name,username=session['username'])
    ...
    def send_mail():
        ...
        if request.method == 'POST': 
            ...
            mycursor.execute('SELECT * FROM  attendance where subject_name= %s',( subnm ,))
            ...
            for i in range(len(attend)):
                ...
                if myresult2:
                    ...
                    msg="Dear Student, "+str(roll)+"\n Your attendance for "+subnm+" subject is "+percent+"%"+"\nKindly contact your subject teacher for any discrepancy.\n-Attendance Department"
